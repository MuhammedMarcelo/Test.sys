...
client.on('ready', function(){
    var ms = 60000 ;
    var setGame = ['mhelp','Type ahelp'marceloh];
    var i = -1;
    var j = 0;
...
${prefix}roles/ÇáÇÏæÇÑ/íÚÑÖ áß ßá ÇáÑÇäßÇÊ ÈÇáÓíÑİÑ ÈÔßá Ìãíá
...
${prefix}ÇáãÍÙæÑíä / ÚÏÏ ÇáÇÔÎÇÕ ÇáãÈäÏÉ 
${prefix}ÕæÑÊí /ÕæÑÊß Çæ ÕæÑÉ Çáí ÊãäÔäæ
...
${prefix}ÇÚØÇÁ @user <rank> / áÃÚØÇÁ ÑÊÈÉ áÚÖæ ãÚíä
${prefix}roleremove @user <rank> / áÇÒÇáÉ ÇáÑÊÈÉ ãä ÔÎÕ ãÚíä
${prefix}ÇÚØí Çáßá <rank> / áÃÚØÇÁ ÑÊÈÉ ááÌãíÚ
${prefix}ÇÚØÇÁ Çáßá <rank> / áÃÚØÇÁ ÑÊÈÉ ááÇÔÎÇÕ İŞØ
${prefix}give bots <rank> / áÃÚØÇÁ ÑÊÈÉ áÌãíÚ ÇáÈæÊÇÊ
${prefix}hchannel / ÇÎİÇÁ ÇáÔÇÊ
${prefix}schannel / ÇÖåÇÑ ÇáÔÇÊ ÇáãÎİíÉ
${prefix}ãÓÍ <numbr> / ãÓÍ ÇáÔÇÊ ÈÚÏÏ
${prefix}ÇÍĞİ Çáßá / ãÓÍ ÇáÔÇÊ
${prefix}ÇÓßÊ @user <time> / ÇÚØÇÁ ÇáÚÖæ ãíæÊ 
${prefix}ÇÊßáã @user / áİß ÇáãíæÊ Úä ÇáÔÎÕ 
${prefix}ØÑÏ @user <reason> / ØÑÏ ÇáÔÎÕ ãä ÇáÓíÑİÑ
${prefix}ÈÇä @user <reason> / ÍÖÑ ÇáÔÎÕ ãä ÇáÓíÑİÑ
${prefix}!mc / ÊŞİíá ÇáÔÇÊ
${prefix}!umc / İÊÍ ÇáÔÇÊ
...
${prefix}áæä <number> / áÎÊíÇÑ áæä
${prefix}deletecolors <number> / áÍĞİ ÇáÇáæÇä
**
   `,`
        ***__Music orders__***
**
${prefix}ÔÛá / áÊÔÛíá ÃÛäíÉ ÈÑÂÈØ Ãæ ÈÃÓã
${prefix}ÊÎØí / áÊÌÂæÒ ÇáÃÛäíÉ ÇáÍÂáíÉ
